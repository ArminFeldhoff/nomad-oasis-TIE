![docker image](https://github.com/ArminFeldhoff/nomad-oasis-TIE/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/ArminFeldhoff/nomad-oasis-TIE.git
    cd nomad-oasis-TIE
    ```
    ...
    ```sh
    curl-L -o nomad-oasis-TIE.zip "https://github.com/ArminFeldhoff/nomad-oasis-TIE/archive/main.zip"
    unzip nomad-oasis-TIE.zip
    cd nomad-oasis-TIE
    ```
...
your `docker-compose.yaml` with `ghcr.io/arminfeldhoff/nomad-oasis-tie:main` for the services
...
```sh
docker pull ghcr.io/arminfeldhoff/nomad-oasis-tie/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/ArminFeldhoff/nomad-oasis-TIE/manifests/main": unauthorized`
